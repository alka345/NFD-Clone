...
function classNames(...classes) {
 ...
 const Navbar = () => {
  ...
  return (
    <Disclosure as="nav" className={colorChange ? "sticky top-0 z-10 w-full text-white bg-slate-900 bg-opacity-50  mx-8 border-solid ":"bg-white mx-8 border-solid rounded-3xl "}>
      {({ open }) => (
        <>
